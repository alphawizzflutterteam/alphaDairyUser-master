...
class _HomeScreenState extends State<HomeScreen> {
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    // ),
                                    // Text(
                                    //   // "Rs. ${double.parse(productDetailsController.productInfo?.productData.productInfo[0].normalPrice.toString() ?? "") * int.parse(isItem1(productDetailsController.productInfo?.productData.id).toString())}",
                                    //   "${tempTotal}",
                                    //   style: TextStyle(
                                    //     fontFamily: FontFamily.gilroyBold,
                                    //     fontSize: 14,
                                    ...
                                    children: [
                                      ...
                                      itemList.isNotEmpty
                                          ? InkWell(
                                              onTap: () {
                                                Get.back();
                                                for (var i = 0; i < productDetailsController.productInfo!.productData.productInfo.length; i++) {

                                                  print( productDetailsController.productInfo!.productData.productInfo[i].productDiscount);
                                                  print( productDetailsController.productInfo!.productData.productInfo[i].subscribePrice);
                                                  print(productDetailsController.productInfo!.productData.productInfo[i].normalPrice);
                                                  if (productDetailsController.productInfo!.productData.productInfo[i].subscriptionRequired == "1" &&
                                                      productDetailsController.productInfo!.productData.productInfo[i].productOutStock == "0") {
                                                    productDetailsController.getProductDetailsApi(
                                                      pId: productDetailsController.productInfo?.productData.id ?? "",
                                                    );
                                                    Get.toNamed(
                                                        Routes.subScribeScreen,
                                                        arguments: {
                                                          "img": productDetailsController.productInfo!.productData.img[0],
                                                          "name": productDetailsController.productInfo!.productData.title,
                                                          "sprice": productDetailsController.productInfo!.productData.productInfo[i].subscribePrice,
                                                          "aprice": productDetailsController.productInfo!.productData.productInfo[i].normalPrice,
                                                          "per": productDetailsController.productInfo!.productData.productInfo[i].productDiscount,
                                                          "attributeId": productDetailsController.productInfo!.productData.productInfo[i].attributeId,
                                                          "productTitle": productDetailsController.productInfo!.productData.productInfo[i].title,
                                                          "isEmpty": "0",
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      productDetailsController
                                              ...
                                              .productInfo[index]
                                              .subscribePrice =
                                          "${double.parse(productDetailsController.productInfo?.productData.productInfo[index].normalPrice.toString() ?? "") - double.parse(productDetailsController.productInfo?.productData.productInfo[index].normalPrice.toString() ?? "") * double.parse(productDetailsController.productInfo?.productData.productInfo[index].productDiscount.toString() ?? "") / 100}";
                                      return Stack(
                                        children: [
                                          Container(
                                            height: 120,
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          Text(
                                                            "Rs. ${productDetailsController.productInfo?.productData.productInfo[index].subscribePrice}",
                                                            style: TextStyle(
                                                              color: BlackColor,
                                                              fontFamily:
                                                                  FontFamily
                                                      ...
                                                      productDetailsController.productInfo?.productData.productInfo[index].productDiscount != "0"
                                                          ? Text(
                                                        "Rs. ${productDetailsController.productInfo?.productData.productInfo[index].normalPrice}",
                                                        style: TextStyle(
                                                            color: greytext,
                                                            fontFamily: FontFamily.gilroyBold,
                                                            fontSize: 13,
                                                              ...
                                                              children: [
                                                                ...
                                                                InkWell(
                                                                  onTap: () {
                                                                    setState(
                                                                        () {
                                                                      if (int.parse(isItem1(productDetailsController
                                                                              .productInfo
                                                                              ?.productData
                                                                              .productInfo[index]
                                                                              .attributeId)) <
                                                                          int.parse("${productDetailsController.productInfo?.productData.productInfo[index].minimumQty}")) {
                                                                        onAddItem1(
                                                                          index,
                                                                        ...
                                                                        Fluttertoast.showToast(
                                                                            msg:
                                                                                "Maximum order quantity per customer is reached");
                                                                      }

                                                                      /*onAddItem1(
                                                                            index,
                                                                            isItem(
                                                                                productDetailsController.productInfo?.productData.productInfo[index].attributeId),
  ...
  getPincode() async {
    ...
    var request = http.Request(
        'POST',
        Uri.parse(
            'https://alpha-dairy-king.developmentalphawizz.com/user_api/d_pincode.php'));
            ...
            return Scaffold(
              ...
              body: SafeArea(
                child: RefreshIndicator(
                  color: gradient.defoultColor,
                  onRefresh: () {
                    homePageController.getNotificationData();
                    getPincode();
                                    ...
                                    InkWell(
                                      onTap: () {
                                        ...
                                        Get.toNamed(Routes.notificationScreen)
                                          ...
                                          print(
                                              "jhjhjhhjhjk${homePageController.isSelected}" +
                                                  "+++++++++++++++");
                                          //   homePageController.updateSelectvalue(false);
                                        });
                                      },
                                      child: Container(
                                        height: 40,
                                        width: 40,
                                        child: homePageController.isSelected ==
                                                true
                                            ? Image.asset(
                                                "assets/notificationread.png",
                                                height: 20,
                                                width: 20,
                                              )
                                            : Image.asset(
                                        ...
                                        child: ListView.builder(
                                          ...
                                          itemBuilder: (context, index1) {
                                            return Column(
                                                ...
                                                ?.catwiseproduct[
                                            index1]
                                                .productdata.isEmpty ?? true
                                            ? Text('Products not available on this pin code')
                                                :   GridView.builder(
                                                        itemCount:
                                                            storeDataContoller
                                                                .storeDataInfo
                                                        ...
                                                        itemBuilder:
                                                          ...
                                                          return storeDataContoller
                                                           ...
                                                           index1]
                                                               .productdata[
                                                           index].productInfo.isEmpty ?? true ? SizedBox() :  Stack(
                                                            clipBehavior:
                                                                Clip.none,
                                                            children: [
                                                              Container(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo.isNotEmpty ?? false
                                                                              ? Padding(
                                                                                  padding: EdgeInsets.symmetric(horizontal: 8),
                                                                                  child: Row(
                                                                                    children: [
                                                                                      ...
                                                                                      Text("${storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].productSubscripitionDiscount ?? ""}%",
                                                                                        maxLines: 2,
                                                                                        style: TextStyle(
                                                                                          fontFamily: FontFamily.gilroyBold,
                                                                                          fontSize: 11,
                                                                              ...
                                                                              : SizedBox(),
                                                                          storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo.isNotEmpty ?? false ? Padding(
                                                                            padding:
                                                                                EdgeInsets.symmetric(horizontal: 8),
                                                                            child:
                                                                                InkWell(
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                         ( storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo.isNotEmpty ?? false) &&   storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].productOutStock == "0"
                                                                              ? Row(
                                                                                  ...
                                                                                  children: [
                                                                                    storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].subscriptionRequired != "0"
                                                                                        ? isSubscibe(storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].attributeId.toString()) != "0"
                                                                                            ? InkWell(
                                                                                                onTap: () {
                                                                                                  ...
                                                                                                  Get.toNamed(Routes.subScribeScreen, arguments: {
                                                                                                   ...
                                                                                                   "sprice":productDetailsController.productInfo!
                                                                                                       .productData
                                                                                                      .productInfo[
                                                                                                  0]
                                                                                                      .normalPrice,
                                                                                                    ...
                                                                                                    "product_subscripition_discount": storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].productDiscount,
                                                                                                  });
                                                                                                  // }
                                                                                                },
                                                                                                child: Container(
                                                                                            ...
                                                                                            : InkWell(
                                                                                                onTap: () {
                                                                                                  //print('index--------${productDetailsController.productInfo!.productData.productInfo[i].subscribePrice}');
                                                                                                  double discount = double.parse(productDetailsController.productInfo!.productData.productInfo[0].normalPrice)*double.parse(storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].productSubscripitionDiscount ?? '0.0') /100 ;
                                                                                                  double subscribePrice = double.parse(productDetailsController.productInfo!.productData.productInfo[0].normalPrice) - discount ;
                                                                                                  productDetailsController.getProductDetailsApi(
                                                                                                    pId: storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productId,
                                                                                                  );
                                                                                                  Get.toNamed(Routes.subScribeScreen, arguments: {
                                                                                                   ...
                                                                                                   //
                                                                                                   //  "sprice": storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].subscribePrice,
                                                                                                    "sprice": subscribePrice.toStringAsFixed(0),
                                                                                                    "aprice": storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].normalPrice,
                                                                                                    "per": storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].productDiscount,
                                                                                                    "attributeId": storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].attributeId,
                                                                                                    "productTitle": storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].title,
                                                                                                    "isEmpty": "0",
                                                                                                    "productId": storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productId,
                                                                                                    "product_subscripition_discount": storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].productSubscripitionDiscount,
                                                                                                  });
                                                                                                  // }
                                                                                                },
                                                                                                child: Container(
                                                                              ...
                                                                              : SizedBox(),
                                                                          //! ------------ Add Product Widget -------------!//
                                                                          storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo.isNotEmpty ?? false ? Row(
                                                                            children: [
                                                                              SizedBox(
                                                                                width: 8,
                                                                              ),
                                                                              Column(
                                                                                children: [
                                                                                  Text(
                                                                                    "Rs. ${double.parse(storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo.first.normalPrice ?? "") - (double.parse(storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo.first.normalPrice ?? "") * double.parse(storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo.first.productDiscount ?? "") / 100)}",
                                                                                    // "500/-",
                                                                                    maxLines: 1,
                                                                                    style: TextStyle(
                                                                                      fontFamily: FontFamily.gilroyBold,
                                                                                  ...
                                                                                  storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].productDiscount != "0"
                                                                                      ? Text(
                                                                                          "Rs. ${storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].normalPrice ?? ""}",
                                                                                          maxLines: 1,
                                                                                          style: TextStyle(
                                                                                            color: greyColor,
                                                                                            fontFamily: FontFamily.gilroyMedium,
                                                                                                      ...
                                                                                                      for (var element in cart.values) {
                                                                                                        if (element.storeID == storeDataContoller.storeDataInfo?.storeInfo.storeId) {
                                                                                                          if (element.cartCheck == "1") {
                                                                                                            ...
                                                                                                            setState(() {
                                                                                                           //   print('${isItem1(productDetailsController.productInfo?.productData.productInfo[index].attributeId)}____________');
                                                                                                              if (int.parse(isItem1(storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].attributeId)) < int.parse("${storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].minimumQty}")) {
                                                                                                                onAddItem(
                                                                                                                  index,
                                                                                                                  isItem(storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].attributeId),
                                                                                                                  id1: storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].attributeId ?? "",
                                                                                                                ...
                                                                                                                Fluttertoast.showToast(msg: "Maximum order quantity per customer is reached");
                                                                                                              }
                                                                                                              /*onAddItem(
                                                                                                              index,
                                                                                                              isItem(storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo[0].attributeId),
                                                              ...
                                                              (storeDataContoller.storeDataInfo?.catwiseproduct[index1].productdata[index].productInfo.isNotEmpty ?? false) &&  storeDataContoller
                                                                          .storeDataInfo
                                                                          ?.catwiseproduct[
                                                                              index1]
                                                                          .productdata[
