...
class _YourCartScreenState extends State<YourCartScreen> {
  ...
  @override
  void initState() {
    print("++++++******+hereer" + widget.CartStatus.toString());
    setState(() {
      save("subClc", true);
    });
                          ...
                          children: [
                                                    ...
                                                    children: [
                                                      ...
                                                      Row(
                                                        children: [
                                                          ...
                                                          Spacer(),
                                                          Text(
                                                            "${cartViewList[index].productSubscripitionDiscount}% OFF",
                                                            style:
                                                            TextStyle(
                                                              color:
                                                ...
                                                children: [
                                                  ...
                                                  InkWell(
                                                    onTap: () {
                                                      ...
                                                      cartController.couponAmt = 0;couponCode = "";
                                                      setState(
                                                              () {});
                                                      if (widget.CartStatus == "1") {
                                                        setState(
                                                                () {
                                                              onRemoveItem(index, isItem(cartViewList[index].id.toString()));
                                                            });
                                                      }
                                                    ...
                                                    onTap: () {
                                                      if (widget.CartStatus == "1") {
                                                        ...
                                                        if (widget.CartStatus == "1") {
                                                          setState(
                                                                  () {
                                                                onAddItem(index, isItem(cartViewList[index].id));
                                                              });
                                                          cartController.getSubTotalClc(pPrice: cartViewList[index].price, subdiv: "pluse");
                                                        }
                                                        if (cartController.cartDataInfo?.storeData.storeIsPickup == "1") {
                                                          if (groupValue == 1) {
                                                            total = cartController.subTotal + int.parse(cartController.cartDataInfo?.storeData.storeCharge ?? "") + int.parse(cartController.cartDataInfo?.storeData.restDcharge ?? "");
                                                            getTotal = total;
                                                          } else {
                                                            total = cartController.subTotal + int.parse(cartController.cartDataInfo?.storeData.storeCharge ?? "");
                                                            getTotal = total;
                                                          }
                                                        } else {
                                                          total = cartController.subTotal + int.parse(cartController.cartDataInfo?.storeData.storeCharge ?? "") + int.parse(cartController.cartDataInfo?.storeData.restDcharge ?? "");
                                                        ...
                                                        showToastMessage(
                                                            "The quantity cannot be modified as it has been prescribed by the doctors.".tr);
                                                      }
                                                    },
                                                    child:
                                                    Container(
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText:
                                "Write instructions, gifting ideas etc..".tr,
            ...
            children: [
              ...
              /*Container(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(border: InputBorder.none,hintText: 'Add Address'),
                ),
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(15),
  ...
  List<CartItem> listOfCart() {
    ...
    for (var element in cart.values) {
      ...
      if (element.storeID == storeDataContoller.storeid) {
        ...
        item.productSubscripitionDiscount = element.productSubscripitionDiscount;
        ...
        if (element.cartCheck == "1") {
          ...
          maxDelivery.add(int.parse(element.selectDelivery.toString()));
        }
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: GetBuilder<CartController>(builder: (context) {
                        return cartController.isLoading
                          ...
                          itemBuilder: (ctx, i) {
                            print("title is ${cartController.cartDataInfo?.paymentData[i].title}");
                            return cartViewList[0].cartCheck == "1" &&
                              ...
                              child: sugestlocationtype(
                                ...
                                title: cartController.cartDataInfo?.storeData.storeIsPickup == "1"
                                          ? groupValue == 0
                                              ? cartController.cartDataInfo?.paymentData[i].title == "Cash On Delivery"
                                                 ? "Pay at Store"
                                                 : cartController.cartDataInfo?.paymentData[i].title ?? ""
                                              : cartController.cartDataInfo?.paymentData[i].title ?? ""
                                    : cartController.cartDataInfo?.paymentData[i].title ?? "",

                                titleColor: BlackColor,
                                isAsset: cartController.cartDataInfo?.storeData.storeIsPickup == "1"
                                          ? groupValue == 0
                                             ? cartController.cartDataInfo?.paymentData[i].title == "Cash On Delivery"
                                                ? true
                                                : false
                                    ...
                                    : false,
                                val: 0,
                                image: Config.imageUrl + cartController.cartDataInfo!.paymentData[i].img,
                                adress: cartController.cartDataInfo?.storeData.storeIsPickup == "1"
                                    ? groupValue == 0 ? cartController.cartDataInfo?.paymentData[i].title == "Cash On Delivery"
                                       ? "Stores may also accept personal checks or money orders as payment."
                                       : cartController.cartDataInfo?.paymentData[i].subtitle ?? ""
                                    : cartController.cartDataInfo
                                ...
                                ontap: () async {
                                  setState(() {
                                    razorpaykey = cartController
                                        ...
                                        .paymentData[i]
                                        .attributes;
                                    paymenttital = cartController.cartDataInfo!.paymentData[i].title;
                                    selectidPay = cartController.cartDataInfo!.paymentData[i].id;
                                    _groupValue = i;
                                  });
                                },
                                radio: Radio(
                    ...
                    Container(
                      ...
                      child: GestButton(
                        ...
                        onclick: () async {
                          // print("hdghsghsgdj ${cartController.cartDataInfo!.paymentData[i].title}");
                          // //!---- Stripe Payment ------
  ...
  Widget sugestlocationtype(
      {Function()? ontap,
        ...
        radio,
        Color? borderColor,
        Color? titleColor, bool? isAsset}) {
    print("i sassets is ${isAsset}");
    return StatefulBuilder(
        builder: (BuildContext context, StateSetter setState) {
          return InkWell(
                  ...
                  isAsset ?? false ? Container(
                      ...
                      child: Center(
                        child: FadeInImage(
                            ...
                            image: AssetImage('assets/SpleshLogo.png')),
  ...
  Future<void> getPhonpayURL() async {
    ...
    var headers = {
      ...
      'Cookie': 'PHPSESSID=uga6mb743mo38gtn3j0rc8ure1'
    };
    var request = http.Request('POST', Uri.parse('https://alpha-dairy-king.developmentalphawizz.com/user_api/u.payment.php'));
    request.body = json.encode({
      "mobile": mobile,
      "ccode": "+91",
      "amount": double.parse(total.toString()).toString(),
      "user_id": getData.read("UserLogin")["id"]
    });
    print("initiate phone pay para${request.body}");
    ...
    if (response.statusCode == 200) {
      ...
      print("merchant trancfags $merchantTransactionId");
  ...
  Future<void> initiatePayment() async {
    ...
    callBackUrl = 'https://alpha-dairy-king.developmentalphawizz.com/user_api/u.success.php/';
    Navigator.push(
      context,
      MaterialPageRoute(
            ...
            onLoadStop: (controller, url) async {
              ...
              if (url.toString().contains(callBackUrl!)) {
                ...
                if(isPhonePayPaymentSuccess ?? false){
                  ...
                  if (widget.CartStatus == "1") {
                    if (cartViewList[0].cartCheck == "0") {
                      buyNormalOrderInStore(merchantTransactionId.toString());
                    } else {
                      subScriptionOrderInStore(merchantTransactionId.toString());
                    }
                  } else {
  ...
  Future<Map<String, dynamic>> fetchDataFromUrl() async {
    try{
      ...
      var request = http.Request('POST', Uri.parse('https://alpha-dairy-king.developmentalphawizz.com/user_api/check_payment.php'));
      request.body = json.encode({
  ...
  void _handlePaymentStatus(String url) async {
    ...
    bool? isError = responseData['data'][0]['status'] == '1' ? true: false;
    if (isError == false) {
      // Payment success
