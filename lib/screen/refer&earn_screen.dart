          ...
          child: SizedBox(
            ...
            child: Column(
              children: [
                ...
                ElevatedButton(
                  style: ButtonStyle(backgroundColor: MaterialStateProperty.all(Color(0xff5D8231))),
                  onPressed: () {
                    Share.share(
                        "Ittavi \n\nhttps://play.google.com/store/apps/details?id=com.ittavi.user");
                  },
                  child: Padding(
